...
export default defineConfig({
  plugins: [react()],
  server: {
    // me permite cambiar el puerto del local para desarrollo
    port: 3030,
  },
  preview: {
    // me permite cambiar el puerto del servidor de prueba pre-productivo
    port: 4270,
  },
  // build options
  build: {
    ...
    babel: {
      // me permite ayudar a babel al reconocimiento del entorno en el cual vas a manipular las versiones del js (opcional)
